...
| `/series search <query>` | Show a series card: cover, description, and its characters ranked first with stars, plus a Browse characters button that opens the usual one-per-page pager. Autocompletes series names. |
